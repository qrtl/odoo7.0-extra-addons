...
#                     rate = rate_obj.read(cr, uid, rate_rec[0], ['rate'], context=context)['rate']
    ...
    _columns ={
               ...
               'residual_base': fields.function(_get_inv_base_amt, type='float',
                    digits_compute=dp.get_precision('Account'), string=u'Balance (Base)', multi='base_amt'),
               'amount_total_base': fields.function(_get_inv_base_amt, type='float',
                    digits_compute=dp.get_precision('Account'), string=u'Total (Base)', multi='base_amt'),
               }
